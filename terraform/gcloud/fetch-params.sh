...
Failed to fetch the Bitcoin Private zkSNARK parameters!
...
function main() {
    ...
    cat <<EOF
Btcp - fetch-params.sh

This script will fetch the Bitcoin private zkSNARK parameters and verify their
